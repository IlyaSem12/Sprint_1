...
## Описание
В данном проекте находятся задания для финального проекта 1 спринта яндекс практикума.
В проекте находятся:
1. Основные заания: `task_{1-5}.py `
2. Дополнительные заания: `task_{6-7}.py `
